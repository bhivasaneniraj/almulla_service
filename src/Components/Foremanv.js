    ...
    <>
      <div className="Foreman_Main">
        <div className="Foreman_cl">
          <img src="/images/bitmap@3x.png" alt="logo" className="bitmap_png" />
          <div className="V0"></div>
          <h3 className="Welcome_head">
            {" "}
          ...
          <div className="headerss">
            ...
            <div className="logoutss">
              ...
              <h1 className="Head" style={{ cursor: "pointer" }}>
                <b>Logout</b>{" "}
              </h1>
            </div>
          </div>
          ...
          <div className="app_foreman">
            <table className="table_for">
              ...
              <tr className="Fore_Man_Data">
                ...
                <td>
                  {ForemanData[1].Status} <img src="./logo/workinprogress@3x.png" alt="logo" />
                </td>
              </tr>
              ...
              <tr className="Fore_Man_Data">
                ...
                <td>
                  {ForemanData[2].Status} <img src="./logo/workinprogress@3x.png" alt="logo" />
                </td>
              </tr>
              ...
              <tr className="Fore_Man_Data">
                ...
                <td>
                  {ForemanData[3].Status} <img src="./logo/workinprogress@3x.png" alt="logo" />
                </td>
              </tr>
            </table>
          </div>
