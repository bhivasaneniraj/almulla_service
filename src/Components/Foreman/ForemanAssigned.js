        ...
        <div className="app_foreman">
          <table className="table_for">
            ...
            <tr className="Fore_Man_Data">
              ...
              <td>
                {ForemanData[0].Status} <img src="./logo/assigned@3x.png" alt="logo" className="Assi_gned" onClick={() => navigate("/Foremanpage")} />
              </td>
            </tr>
            ...
            <tr className="Fore_Man_Data">
              ...
              <td>
                {ForemanData[1].Status} <img src="./logo/assigned@3x.png" alt="logo" className="Assi_gned" onClick={() => navigate("/Foremanpage")} />
              </td>
            </tr>
            ...
            <tr className="Fore_Man_Data">
              ...
              <td>
                {ForemanData[2].Status} <img src="./logo/assigned@3x.png" alt="logo" className="Assi_gned" onClick={() => navigate("/Foremanpage")} />
              </td>
            </tr>
            ...
            <tr className="Fore_Man_Data">
              ...
              <td>
                {ForemanData[3].Status} <img src="./logo/assigned@3x.png" alt="logo" className="Assi_gned" onClick={() => navigate("/Foremanpage")} />
              </td>
            </tr>
          </table>
        </div>
